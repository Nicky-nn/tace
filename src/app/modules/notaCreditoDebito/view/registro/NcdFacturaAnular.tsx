...
import { fetchNcdFacturaAnular } from '../../api/ncdFacturaAnular.api'
...
const AnularNcdDocumentoDialog: FunctionComponent<Props> = (props: Props) => {
    ...
    if (aux) {
      Swal.fire({
        ...
        preConfirm: () => {
          ...
          return fetchNcdFacturaAnular(factura?.cuf || '', value.codigoMotivo)
        },
...
export default AnularNcdDocumentoDialog
